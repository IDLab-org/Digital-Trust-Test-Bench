...
def reports():
    ...
    return render_template("pages/reports.jinja", title="Dashboard | DTT", projects=projects)
...
def project_report(project_id: str):
    ...
    r = requests.get(f"http://localhost:5050/emailable-report/render?project_id={project_id}")
